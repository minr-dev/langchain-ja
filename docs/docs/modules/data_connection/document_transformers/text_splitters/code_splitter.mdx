...
CodeTextSplitterを使用すると、複数の言語に対応したコードの分割が可能です。列挙型`Language`をインポートして、分割するコードの言語を指定してください。
...
Markdownテキストスプリッターを使用した例をこちらに示します：
