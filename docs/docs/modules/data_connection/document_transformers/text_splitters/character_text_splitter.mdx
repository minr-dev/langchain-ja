# Split by character | 文字ごとに分割する

これは最もシンプルな方法です。この方法は、文字（デフォルトでは「\n\n」）を基に分割し、チャンクの長さを文字数で測定します。

> This is the simplest method. This splits based on characters (by default "\n\n") and measure chunk length by number of characters.

1. テキストがどのように分割されるか：単一文字ごと。
...
こちらは、ドキュメントと一緒にメタデータを渡す例です。それがドキュメントと共に分割されていることに注目してください。
